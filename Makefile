...
# Source files
SRCS = $(SRC_DIR)/main.c $(SRC_DIR)/execute_ls.c $(SRC_DIR)/execute_pwd.c $(SRC_DIR)/execute_cd.c $(SRC_DIR)/execute_exit.c $(SRC_DIR)/execute_touch.c $(SRC_DIR)/execute_cat.c $(SRC_DIR)/execute_echo.c
